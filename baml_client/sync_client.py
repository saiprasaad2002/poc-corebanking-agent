...
class BamlSyncClient:
    ...
    def CheckIntent(self, question: str,
        ...
        result = self.__options.merge_options(baml_options).call_function_sync(function_name="CheckIntent", args={
            "question": question,
        })
    ...
    def Claritycheckfunction(self, user_question: str,tools: typing.List[str],description: typing.List[str],user_role: str,
        ...
        result = self.__options.merge_options(baml_options).call_function_sync(function_name="Claritycheckfunction", args={
    ...
    def FetchResults(self, markdown_content: str,user_question: str,
        ...
        result = self.__options.merge_options(baml_options).call_function_sync(function_name="FetchResults", args={
    ...
    def ValidateToolCalling(self, user_question: str,tools: typing.List[str],description: typing.List[str],user_role: str,
        ...
        result = self.__options.merge_options(baml_options).call_function_sync(function_name="ValidateToolCalling", args={
            "user_question": user_question,"tools": tools,"description": description,"user_role": user_role,
        })
...
class BamlStreamClient:
    ...
    def CheckIntent(self, question: str,
        ...
        ctx, result = self.__options.merge_options(baml_options).create_sync_stream(function_name="CheckIntent", args={
            "question": question,
        })
    ...
    def Claritycheckfunction(self, user_question: str,tools: typing.List[str],description: typing.List[str],user_role: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.ClarityCheck, types.ClarityCheck]:
        ctx, result = self.__options.merge_options(baml_options).create_sync_stream(function_name="Claritycheckfunction", args={
            "user_question": user_question,"tools": tools,"description": description,"user_role": user_role,
        })
        return baml_py.BamlSyncStream[stream_types.ClarityCheck, types.ClarityCheck](
          result,
    ...
    def FetchResults(self, markdown_content: str,user_question: str,
        ...
        ctx, result = self.__options.merge_options(baml_options).create_sync_stream(function_name="FetchResults", args={
            "markdown_content": markdown_content,"user_question": user_question,
        })
        return baml_py.BamlSyncStream[stream_types.Parameters, types.Parameters](
          result,
    ...
    def ValidateToolCalling(self, user_question: str,tools: typing.List[str],description: typing.List[str],user_role: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.Toolvalidation, types.Toolvalidation]:
        ctx, result = self.__options.merge_options(baml_options).create_sync_stream(function_name="ValidateToolCalling", args={
            "user_question": user_question,"tools": tools,"description": description,"user_role": user_role,
        })
        return baml_py.BamlSyncStream[stream_types.Toolvalidation, types.Toolvalidation](
          result,
...
class BamlHttpRequestClient:
    ...
    def CheckIntent(self, question: str,
        ...
        result = self.__options.merge_options(baml_options).create_http_request_sync(function_name="CheckIntent", args={
            "question": question,
        }, mode="request")
        return result
    def Claritycheckfunction(self, user_question: str,tools: typing.List[str],description: typing.List[str],user_role: str,
        ...
        result = self.__options.merge_options(baml_options).create_http_request_sync(function_name="Claritycheckfunction", args={
            "user_question": user_question,"tools": tools,"description": description,"user_role": user_role,
        }, mode="request")
        return result
    def ExtractResume(self, resume: str,
    ...
    def ValidateToolCalling(self, user_question: str,tools: typing.List[str],description: typing.List[str],user_role: str,
        ...
        result = self.__options.merge_options(baml_options).create_http_request_sync(function_name="ValidateToolCalling", args={
            "user_question": user_question,"tools": tools,"description": description,"user_role": user_role,
        }, mode="request")
        return result
